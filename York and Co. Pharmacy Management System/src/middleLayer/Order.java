...
//	double priceAtPurchase;
	...
	public void addOrderToPatient(int _patientID, int _medicationId, int _qty , String _isPres, int _numOfRefills) throws Exception {
	...
	public void Save() throws Exception {
		...
		_orderDao.saveToOrder(patientID, medicationID, quantityBought,isPres , numOfRefills);
